...
int main ( int argc, char *argv[] ) {
  ...
  thread_tasks[0].loading_time = 500;
  thread_tasks[0].exit_time = 1000000;
  ...
  thread_tasks[1].loading_time = 500;
  thread_tasks[1].exit_time = 1000000;
  thread_tasks[1].priority = 1;
  ...
  thread_tasks[2].loading_time = 500;
  thread_tasks[2].exit_time = 1000000;
