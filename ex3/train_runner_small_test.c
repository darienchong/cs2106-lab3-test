...
int main ( int argc, char *argv[] ) {
  ...
  thread_tasks[0].train_id = 0;
  thread_tasks[0].loading_time = 300000;
  thread_tasks[0].exit_time = 200;
  thread_tasks[0].priority = 0;
  thread_tasks[0].entry_controller = common_entry_controller;
  thread_tasks[0].exit_controller = common_exit_controller;
  pthread_create( &threads[0], NULL, simulate_train, (void*) &thread_tasks[0] );

  usleep(50000);

  thread_tasks[1].train_id = 1;
  thread_tasks[1].loading_time = 300000;
  thread_tasks[1].exit_time = 200;
  thread_tasks[1].priority = 0;
  thread_tasks[1].entry_controller = common_entry_controller;
  thread_tasks[1].exit_controller = common_exit_controller;
  pthread_create( &threads[1], NULL, simulate_train, (void*) &thread_tasks[1] );

  usleep(50000); // Make sure that train 0 and 1 are in the loading bays

  thread_tasks[2].train_id = 2;
  thread_tasks[2].loading_time = 300000;
  thread_tasks[2].exit_time = 200;
  thread_tasks[2].priority = 0;
  thread_tasks[2].entry_controller = common_entry_controller;
  thread_tasks[2].exit_controller = common_exit_controller;
  pthread_create( &threads[2], NULL, simulate_train, (void*) &thread_tasks[2] );

  usleep(50000);

  thread_tasks[3].train_id = 3;
  thread_tasks[3].loading_time = 300000;
  thread_tasks[3].exit_time = 200;
  thread_tasks[3].priority = 0;
  thread_tasks[3].entry_controller = common_entry_controller;
  thread_tasks[3].exit_controller = common_exit_controller;
  pthread_create( &threads[3], NULL, simulate_train, (void*) &thread_tasks[3] );

  usleep(50000);

  thread_tasks[4].train_id = 4;
  thread_tasks[4].loading_time = 300000;
  thread_tasks[4].exit_time = 200;
  thread_tasks[4].priority = 0;
  thread_tasks[4].entry_controller = common_entry_controller;
  thread_tasks[4].exit_controller = common_exit_controller;
  pthread_create( &threads[4], NULL, simulate_train, (void*) &thread_tasks[4] );
